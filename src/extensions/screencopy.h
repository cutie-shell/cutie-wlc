...
class ScreencopyManagerV1
	: public QWaylandCompositorExtensionTemplate<ScreencopyManagerV1>,
...

{
    ...
    protected:
	void zwlr_screencopy_manager_v1_capture_output(
...
class ScreencopyFrameV1
	: public QWaylandCompositorExtensionTemplate<ScreencopyFrameV1>,
    ...
    protected:
	void
	zwlr_screencopy_frame_v1_copy(Resource *resource,
				      struct ::wl_resource *buffer) override;
