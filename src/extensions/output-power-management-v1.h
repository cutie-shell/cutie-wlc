...
class OutputPowerManagerV1 : public QWaylandCompositorExtensionTemplate<OutputPowerManagerV1>
...
protected:
	void zwlr_output_power_manager_v1_get_output_power(Resource *resource, uint32_t id, struct ::wl_resource *output) override;
...
protected:
	void zwlr_output_power_v1_set_mode(Resource *resource, uint32_t mode) override;
