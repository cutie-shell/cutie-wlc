...
class TextInputManagerV1
	: public QWaylandCompositorExtensionTemplate<TextInputManagerV1>,
...

{
    ...
    protected:
	void zwp_text_input_manager_v1_create_text_input(Resource *resource,
...
class TextInputV1 : public QWaylandCompositorExtensionTemplate<TextInputV1>,
	...
	void zwp_text_input_v1_activate(Resource *resource,
					struct ::wl_resource *seat,
					struct ::wl_resource *surface) override;
	void zwp_text_input_v1_deactivate(Resource *resource,
	...
	void zwp_text_input_v1_set_surrounding_text(Resource *resource,
						    const QString &text,
						    uint32_t cursor,
						    uint32_t anchor) override;
	void zwp_text_input_v1_set_content_type(Resource *resource,
						uint32_t hint,
						uint32_t purpose) override;
	void zwp_text_input_v1_set_cursor_rectangle(Resource *resource,
						    int32_t x, int32_t y,
						    int32_t width,
						    int32_t height) override;
	void zwp_text_input_v1_set_preferred_language(
		Resource *resource, const QString &language) override;
	void zwp_text_input_v1_commit_state(Resource *resource,
					    uint32_t serial) override;
	void zwp_text_input_v1_invoke_action(Resource *resource,
					     uint32_t button,
