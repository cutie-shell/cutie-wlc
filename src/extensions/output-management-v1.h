...
class OutputManagerV1 : public QWaylandCompositorExtensionTemplate<OutputManagerV1>
...
protected:
	...
	void zwlr_output_manager_v1_destroy_resource(Resource *resource) override;
...
class OutputConfigurationV1 : public QWaylandCompositorExtensionTemplate<OutputConfigurationV1>
	, public QtWaylandServer::zwlr_output_configuration_v1 {
	Q_OBJECT
public:
	OutputConfigurationV1(struct ::wl_client *client, uint32_t id, int version);
...
class OutputConfigurationHeadV1 : public QWaylandCompositorExtensionTemplate<OutputConfigurationHeadV1>
	, public QtWaylandServer::zwlr_output_configuration_head_v1 {
	Q_OBJECT
public:
	OutputConfigurationHeadV1(struct ::wl_client *client, uint32_t id, int version);
	int m_scale;

protected:
	void zwlr_output_configuration_head_v1_set_mode(Resource *resource, struct ::wl_resource *mode) override;
	...
	void zwlr_output_configuration_head_v1_set_transform(Resource *resource, int32_t transform) override;
	void zwlr_output_configuration_head_v1_set_scale(Resource *resource, wl_fixed_t scale) override;
	void zwlr_output_configuration_head_v1_set_adaptive_sync(Resource *resource, uint32_t state) override;
};
